...
Up to this point, we trained and tested two classifiers, SVM and Neural Network. The dataset we used is a subset of 5000 images from the CIFAR-10.
...
Detailed and precise description of method. This should be complete with equations, optimization procedure, and how you plan on evaluating your method\cite{wiki}
...
\section{Overall quality of writing}
